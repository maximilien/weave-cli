...
development coverage after Day 20 is **62.17%** (`17,128 / 27,551`) with
**83.53% function coverage** (`1,770 / 2,119`). Codecov ratchets project
coverage at 62% and requires 80% patch coverage.
