...
development coverage after Day 11 is **42.08%** (`11,586 / 27,531`) with
**64.29% function coverage** (`1,359 / 2,114`). Codecov ratchets project
coverage at 42% and requires 80% patch coverage.
